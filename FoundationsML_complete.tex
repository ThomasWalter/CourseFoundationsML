...
\author[Walter \& Azencott]{Thomas Walter \and  Chlo\'e-Agathe~Azencott}
...
\begin{document}
{
  ...
  \begin{frame}[plain]
    ...
    \begin{center}
      {\ptnormal{\textit{Formation Dassault-Systèmes}}}
    \end{center}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item 20 personnes, 6 chercheurs permanents (dont 2 chaires PRAIRIE)
...
\begin{frame}
  ...
  \item \blue{Cours 1 :} Minimisation du risque empirique (Thomas Walter)
  \item \blue{Cours 2 :} Régularisation et sélection de modèle (Chloé Azencott)
  \item \blue{Cours 3 :} Apprentissage non-supervisé (Thomas Walter) 
  \item \blue{Cours 4 :} Arbres et méthodes ensemblistes (Chloé Azencott)
  \item \blue{Cours 5 :} Réseaux de neurones (Vincent Mallet)
  \item \blue{Cours 6 :} Apprentissage profond (Vincent Mallet)
...
\begin{frame}
  \begin{center}
    \red{\LARGE Cours 1 -- Minimisation du risque empirique et modèles linéaires}
  \end{center}
\end{frame}
\input{erm}
...
\begin{frame}
  \begin{center}
    \red{\LARGE Cours 3 -- Apprentissage non-supervisé} 
  \end{center}
\end{frame}
\input{unsupervised}
...
\begin{frame}
  \begin{center}
    \red{\LARGE Cours 4 -- Arbres et méthodes ensemblistes} 
  \end{center}
\end{frame}
\input{trees}
